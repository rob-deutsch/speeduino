...
void test_status_running_to_pending_ign1(void)
{
    ...
    while(ignitionSchedule[0].Status == SCH_RUNNING) /*Wait*/ ;
...
void test_status_running_to_pending_ign2(void)
{
    ...
    while(ignitionSchedule[1].Status == SCH_RUNNING) /*Wait*/ ;
...
void test_status_running_to_pending_ign3(void)
{
    ...
    while(ignitionSchedule[2].Status == SCH_RUNNING) /*Wait*/ ;
...
void test_status_running_to_pending_ign4(void)
{
    ...
    while(ignitionSchedule[3].Status == SCH_RUNNING) /*Wait*/ ;
...
void test_status_running_to_pending_ign5(void)
{
    ...
    while(ignitionSchedule[4].Status == SCH_RUNNING) /*Wait*/ ;
...
void test_status_running_to_pending_ign6(void)
{
    ...
    while(ignitionSchedule[5].Status == SCH_RUNNING) /*Wait*/ ;
...
void test_status_running_to_pending_ign7(void)
{
    ...
    while(ignitionSchedule[6].Status == SCH_RUNNING) /*Wait*/ ;
...
void test_status_running_to_pending_ign8(void)
{
    ...
    while(ignitionSchedule[7].Status == SCH_RUNNING) /*Wait*/ ;
