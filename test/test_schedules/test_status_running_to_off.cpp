...
void test_status_running_to_off_inj1(void)
{
    ...
    while( (fuelSchedule1.Status == PENDING_SPEEDUINO) || (fuelSchedule1.Status == RUNNING) ) /*Wait*/ ;
...
void test_status_running_to_off_inj2(void)
{
    ...
    while( (fuelSchedule2.Status == PENDING_SPEEDUINO) || (fuelSchedule2.Status == RUNNING) ) /*Wait*/ ;
...
void test_status_running_to_off_inj3(void)
{
    ...
    while( (fuelSchedule3.Status == PENDING_SPEEDUINO) || (fuelSchedule3.Status == RUNNING) ) /*Wait*/ ;
...
void test_status_running_to_off_inj4(void)
{
    ...
    while( (fuelSchedule4.Status == PENDING_SPEEDUINO) || (fuelSchedule4.Status == RUNNING) ) /*Wait*/ ;
...
void test_status_running_to_off_inj5(void)
{
    ...
    while( (fuelSchedule5.Status == PENDING_SPEEDUINO) || (fuelSchedule5.Status == RUNNING) ) /*Wait*/ ;
...
void test_status_running_to_off_inj6(void)
{
    ...
    while( (fuelSchedule6.Status == PENDING_SPEEDUINO) || (fuelSchedule6.Status == RUNNING) ) /*Wait*/ ;
...
void test_status_running_to_off_inj7(void)
{
    ...
    while( (fuelSchedule7.Status == PENDING_SPEEDUINO) || (fuelSchedule7.Status == RUNNING) ) /*Wait*/ ;
...
void test_status_running_to_off_inj8(void)
{
    ...
    while( (fuelSchedule8.Status == PENDING_SPEEDUINO) || (fuelSchedule8.Status == RUNNING) ) /*Wait*/ ;
...
void test_status_running_to_off_ign1(void)
{
    ...
    while( (ignitionSchedule1.Status == PENDING_SPEEDUINO) || (ignitionSchedule1.Status == RUNNING) ) /*Wait*/ ;
...
void test_status_running_to_off_ign2(void)
{
    ...
    while( (ignitionSchedule2.Status == PENDING_SPEEDUINO) || (ignitionSchedule2.Status == RUNNING) ) /*Wait*/ ;
...
void test_status_running_to_off_ign3(void)
{
    ...
    while( (ignitionSchedule3.Status == PENDING_SPEEDUINO) || (ignitionSchedule3.Status == RUNNING) ) /*Wait*/ ;
...
void test_status_running_to_off_ign4(void)
{
    ...
    while( (ignitionSchedule4.Status == PENDING_SPEEDUINO) || (ignitionSchedule4.Status == RUNNING) ) /*Wait*/ ;
...
void test_status_running_to_off_ign5(void)
{
    ...
    while( (ignitionSchedule5.Status == PENDING_SPEEDUINO) || (ignitionSchedule5.Status == RUNNING) ) /*Wait*/ ;
...
void test_status_running_to_off_ign6(void)
{
    ...
    while( (ignitionSchedule6.Status == PENDING_SPEEDUINO) || (ignitionSchedule6.Status == RUNNING) ) /*Wait*/ ;
...
void test_status_running_to_off_ign7(void)
{
    ...
    while( (ignitionSchedule7.Status == PENDING_SPEEDUINO) || (ignitionSchedule7.Status == RUNNING) ) /*Wait*/ ;
...
void test_status_running_to_off_ign8(void)
{
    ...
    while( (ignitionSchedule8.Status == PENDING_SPEEDUINO) || (ignitionSchedule8.Status == RUNNING) ) /*Wait*/ ;
